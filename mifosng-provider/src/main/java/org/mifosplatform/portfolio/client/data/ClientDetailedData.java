...
public class ClientDetailedData {
	...
	private  final Collection<CodeValueData> country;
	...
	public ClientDetailedData(ClientData clientBasicDetails,
			...
			Collection<CodeValueData> country,
			...
			Collection<CodeValueData> presentLoanSourceseTypes,
			Collection<CodeValueData> presentLoanPurposeTypes,
			...
			Collection<CodeValueData>spouseRelationShip)
 {
	...
	public Collection<CodeValueData> getCountry() {
		return country;
	}
