package com.conflux.client.ext.data;
...
public class AddressExtData {
	...
	private final String countryLable;
	...
	public static AddressExtData formAddressExtData(final Address address) {
        ...
        if(address.getCountry() !=null){
        	...
        	countryLable = address.getCountry().label();
        }
		...
		return new AddressExtData(id, addressType, addressTypeLabel, houseNo,
				...
				district, districtLable, state, stateLabel, country, countryLable, pinCode,
				landlineNo, mobileNo);
	}
	...
	private AddressExtData(final Long id, final Long addressType,
			...
			final String stateLabel,final Long country,
			final String countryLable, final Integer pinCode,
